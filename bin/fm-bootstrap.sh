...
case "$BACKEND" in
  orca) TOOLS="orca node git gh gh-axi chrome-devtools-axi lavish-axi tasks-axi quota-axi" ;;
  *) TOOLS="tmux node git gh treehouse gh-axi chrome-devtools-axi lavish-axi tasks-axi quota-axi" ;;
esac
