...
Secondmate project lists may include remote-backed projects, including projects with legacy mode records.
`local-only` projects stay with the main firstmate.
Seeding never initializes or invokes a delivery gate inside a project clone.
