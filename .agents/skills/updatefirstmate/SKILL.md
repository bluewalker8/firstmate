...
Firstmate is its own repo, so new tracked material (`AGENTS.md`, `bin/`, `.agents/skills/`, and public `skills/`) reaches `main` through the isolated direct-PR contract and then sits there until each running firstmate pulls it.
