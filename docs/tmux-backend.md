...
A second case matters for a harness that shells out to subcommands while it runs (git, npm, test runners, and similar): does `pane_current_command` report the harness or the subcommand?
