...
# validation, treehouse lease handling, clone isolation, child-worktree
...
test_home_seed_refuses_local_only_project() {
  ...
  grep -F 'project alpha is local-only; secondmate routes support only remote-backed projects' "$err" >/dev/null \
