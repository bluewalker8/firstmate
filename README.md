...
- **Explicit project modes** - projects default to isolated `direct-PR` delivery or explicitly use `local-only`, with an optional `+yolo` autonomy flag; legacy mode records reconcile through the direct-PR path.
